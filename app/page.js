  ...
  return (
    <main className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-950 text-white">
      <div className="text-center px-4">
        <h1 className="text-5xl mdLtext-7xl font-bold mb-6">
          Welcome to <span className="text-promary">SmartPOS</span>
        </h1>
        <p className="text-grap-400 text-lg md:text-xl mb-10">
