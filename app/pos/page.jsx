...
export default function POS() {
    ...
    return (
        <div className="flex flex-col md:flex-row h-screen relative bg-background text-foreground">
            <Button onClick={() => setCartVisible(true)} className="md:hidden fixed bottom-4 right-4 z-50">
                View Cart
            </Button>
            {/* Main Content */}
                    ...
                    {loadingProducts ? (
                        ...
                        products.map((product, index) => (
                            <Card 
                                ...
                                className="w-full cursor-pointer overflow-hidden rounded-lg border-primary shadow-sm p-0 hover:opacity-80"
                            >
                            <img
                                src={
            ...
            {/* Cart Sidebar */}
            <div className={`
                fixed md:static top-0 right-0 h-full w-80 bg-muted border-1 p-4 overflow-auto z-40
